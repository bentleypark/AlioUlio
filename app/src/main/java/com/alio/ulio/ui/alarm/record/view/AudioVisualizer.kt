package com.alio.ulio.ui.alarm.record.view
...
class AudioVisualizer(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private val barsCount = 14
    private val barsColor = Color.argb(200, 181, 111, 233)
    private val backgroundColor = Color.WHITE

    private val paint: Paint = Paint()

    var start: Int = Color.parseColor("#FF998A")
    var end: Int =  Color.parseColor("#759CFF")
    ...
    fun visualizeData() {
        ...
        val barWidth = width / (barsCount * 3.5f) // 2f is for the space between bars
    ...
    private val maxMagnitude = calculateMagnitude(120f, 120f)
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        paint.shader = LinearGradient(0f, 0f, w.toFloat(), 0f, start, end, Shader.TileMode.CLAMP)
        visualizeData()
    }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.apply {
            data.forEach {
                drawRoundRect(it, 25f, 25f, paint)
            }
        }
    }
